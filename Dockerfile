...
RUN wget --no-check-certificate https://dlcdn.apache.org/tomcat/tomcat-8/v8.5.73/bin/apache-tomcat-8.5.73.tar.gz
RUN tar -zxvf apache-tomcat-8.5.73.tar.gz -C /opt/tomcat --strip-components=1
